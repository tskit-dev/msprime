...
latex_documents = [
    (master_doc, "msprime.tex", "msprime Documentation", "Jerome Kelleher", "manual"),
]
...
man_pages = [(master_doc, "msprime", "msprime Documentation", [author], 1)]
